...
export const Settings = ({ className = '', size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m11-7h-6m-6 0H1m15.5-3.5L19 8.5m-14 7L7.5 13m11 0L16 10.5M8 21l-2.5-2.5" />
  </svg>
);
...
export const FileText = ({ className = '', size = 24 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M14,2 L14,8 L20,8 M14,2 L14,8 L20,8 M14,2 L4,2 C2.9,2 2,2.9 2,4 L2,20 C2,21.1 2.9,22 4,22 L20,22 C21.1,22 22,21.1 22,20 L22,8 Z" />
